...
void  OS_CPU_SysTickInit (void)
{
	...
	HAL_SYSTICK_Config( OS_CPU_SysTickClkFreq()/OS_TICKS_PER_SEC );

	HAL_NVIC_SetPriority(SysTick_IRQn, 0, 0);	/* Set prio of SysTick handler to min prio.*/
}
