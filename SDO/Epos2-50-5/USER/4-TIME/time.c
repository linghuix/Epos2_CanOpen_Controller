...
void TIME3_Configuration(void) {
  ...
  TIM_TimeBaseStructure.TIM_Period =
      1000; /*设置在下一个更新事件装入活动的自动重装载寄存器周期的值,计数到5000为500ms*/

  TIM_TimeBaseStructure.TIM_Prescaler =
      (7200 -
       1); /*设置用来作为TIMx时钟频率除数的预分频值72MHz / (7200) = 10000Hz*/
  ...
  // TIM_ITConfig(TIM3,TIM_IT_Update|TIM_IT_Trigger,ENABLE);  主程序中控制
  // /*使能或者失能指定的TIM中断*/
...
void TIME2_Configuration(void) {
  ...
  TIM_TimeBaseStructure.TIM_Period =
      5000; /*设置在下一个更新事件装入活动的自动重装载寄存器周期的值,计数到10000为10ms*/

  TIM_TimeBaseStructure.TIM_Prescaler =
      (72 - 1); /*设置用来作为TIMx时钟频率除数的预分频值 72MHz/72 = 1MHz */
...
extern int hip_0_5m[114], hip_1_5m[204], hip_0_10m[57], hip_1_10m[102],
    hip_0_15m[38], hip_1_15m[68];
extern int knee_0_5m[58], knee_1_5m[204], knee_0_10m[29], knee_1_10m[102],
    knee_0_15m[19], knee_1_15m[68];
